...
class MapTRPerceptionTransformer(BaseModule):
    """Implements the MapTR transformer.
    Args:
    ...
    def __init__(self,
        ...
        self.use_attn_bev = encoder['type'] == 'BEVFormerEncoderSparse' or encoder['type'] == 'BEVFormerEncoder'
    ...
    def forward(self,
                ...
                prev_bev=None,
                **kwargs):
        """Forward function for `MapTRTransformer`.
        Args:
