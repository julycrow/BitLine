...
class BitLine(MVXTwoStageDetector):
    ...
    def Graphpred2result(self, line_scores, line_labels, line, 
                                ...
                                graph=None, adj_matrix=None, query_index=None):
        ...
        if query_index is not None:
            result_dict['query_index'] = query_index  # GIF可视化用：过滤后的query索引
    ...
    def simple_test_graph(self, x, lidar_feat, img_metas, prev_bev=None, rescale=False):
        ...
        bbox_results = [
            ...
            for line_scores, line_labels, line, 
                pts_scores, pts_labels, pts, graphs, adj_matrix, query_index in pts_list
        ]
        # import pdb;pdb.set_trace()
